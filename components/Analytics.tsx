    ...
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-500 dark:text-slate-400">Deep dive into data with custom reports.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="p-6 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm flex flex-col items-center justify-center text-center h-64 hover:border-nexus-300 dark:hover:border-nexus-700 transition-colors cursor-pointer group">
              ...
              <h3 className="font-semibold text-slate-900 dark:text-white">Revenue Report</h3>
              <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">Monthly recurring revenue breakdown</p>
          </div>
          ...
          <div className="p-6 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm flex flex-col items-center justify-center text-center h-64 hover:border-nexus-300 dark:hover:border-nexus-700 transition-colors cursor-pointer group">
              ...
              <h3 className="font-semibold text-slate-900 dark:text-white">Client Demographics</h3>
              <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">Industry and region distribution</p>
          </div>
          ...
          <div className="p-6 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm flex flex-col items-center justify-center text-center h-64 hover:border-nexus-300 dark:hover:border-nexus-700 transition-colors cursor-pointer group">
              ...
              <h3 className="font-semibold text-slate-900 dark:text-white">Traffic Sources</h3>
              <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">Web and mobile app analytics</p>
          </div>
      </div>

      <div className="bg-white dark:bg-slate-900 p-6 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm h-[400px]">
          <h3 className="font-semibold text-slate-900 dark:text-white mb-6">Traffic Analysis</h3>
