...
export const CRM: React.FC = () => {
  const getStatusColor = (status: string) => {
    switch (status) {
      ...
      case 'Churned': return 'bg-gray-100 text-gray-700 dark:bg-gray-800 dark:text-gray-400';
    ...
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-gray-500 dark:text-slate-400">Manage relationships, track leads, and close deals.</p>
        </div>
        <div className="flex gap-2">
           <button className="p-2 bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-lg text-gray-600 dark:text-slate-300 hover:bg-gray-50 dark:hover:bg-slate-700">
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left text-sm">
            <thead className="bg-gray-50 dark:bg-slate-950 border-b border-gray-200 dark:border-slate-800">
              <tr>
                <th className="px-6 py-4 font-semibold text-gray-900 dark:text-white">Client Name</th>
                ...
                <th className="px-6 py-4 font-semibold text-gray-900 dark:text-white">Value</th>
                <th className="px-6 py-4 font-semibold text-gray-900 dark:text-white">Last Contact</th>
            ...
            <tbody className="divide-y divide-gray-100 dark:divide-slate-800">
              {CLIENTS.map((client) => (
                <tr key={client.id} className="hover:bg-gray-50 dark:hover:bg-slate-800/50 transition-colors">
                  ...
                  <td className="px-6 py-4 text-gray-600 dark:text-slate-400">{client.company}</td>
                  <td className="px-6 py-4">
                  ...
                  <td className="px-6 py-4 text-right">
                    <div className="flex items-center justify-end gap-2">
                        <button className="p-1.5 hover:bg-gray-100 dark:hover:bg-slate-800 rounded text-gray-400 hover:text-nexus-600 transition-colors">
                            <Mail className="w-4 h-4" />
                        </button>
                        <button className="p-1.5 hover:bg-gray-100 dark:hover:bg-slate-800 rounded text-gray-400 hover:text-nexus-600 transition-colors">
                            <Phone className="w-4 h-4" />
                        </button>
                        <button className="p-1.5 hover:bg-gray-100 dark:hover:bg-slate-800 rounded text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors">
